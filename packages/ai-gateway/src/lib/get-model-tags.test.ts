...
describe("getModelTags", () => {
  const testCases: {
    ...
    { expected: ["coding", "legacy"], modelId: "gpt-5.1-codex-mini" },
    { expected: ["coding", "legacy"], modelId: "gpt-5.1-codex-nano" },
    { expected: ["coding", "legacy"], modelId: "gpt-5.1-mini" },
    { expected: ["coding", "recommended"], modelId: "gpt-5.2" },
    { expected: ["coding", "recommended"], modelId: "gpt-5.2-pro" },
    { expected: ["coding", "recommended"], modelId: "gpt-5.2-pro-2025-12-11" },
    ...
    { expected: [], modelId: "claude-sonnet-3.5" },
    { expected: [], modelId: "claude-opus-3" },
    ...
    { expected: ["coding", "legacy"], modelId: "glm-4.5" },
    { expected: ["coding", "legacy"], modelId: "glm-4.5-air" },
