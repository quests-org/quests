      ...
      [
        ...
        },
        {
          ...
          "parts": [
            ...
            {
              "errorText": "Model tried to call unavailable tool 'non_existent_tool'. Available tools: choose, edit_file, generate_image, glob, grep, read_file, run_diagnostics, run_shell_command, task, think, unavailable, web_search, write_file.",
              "input": undefined,
              "metadata": {
                "createdAt": 2013-08-31T12:00:04.000Z,
                "endedAt": 2013-08-31T12:00:05.000Z,
